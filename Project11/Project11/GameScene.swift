...
//  Project11
//
//  Created by Yunus Emre Bayezit on 21.08.2022.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
            ...
            let objects = nodes(at: location)
                ...
                if objects.contains(editLabel) {
                    ...
                    if editingMode {
                        ...
                        if location.y > 600{
                        let ball = SKSpriteNode(imageNamed: balls[Int.random(in:0...balls.count-1)])
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if nodeA.name == "ball" {
            ...
            collisionBetween(ball: nodeB, object: nodeA)
        } else if nodeA.name == "bounce" {
            
        } else if nodeB.name == "bounce" {
